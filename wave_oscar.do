...
add wave -noupdate -divider {Node(0,1) IF}
add wave -noupdate -group {north_down[0]} -expand {/tb_noc/north_down[0]/flit}
add wave -noupdate -group {north_down[0]} {/tb_noc/north_down[0]/enable}
add wave -noupdate -group {north_down[0]} {/tb_noc/north_down[0]/ack}
add wave -noupdate -group {north_up[0]} {/tb_noc/north_up[0]/flit}
add wave -noupdate -group {north_up[0]} {/tb_noc/north_up[0]/enable}
add wave -noupdate -group {north_up[0]} {/tb_noc/north_up[0]/ack}
...
add wave -noupdate -group {west_up[0]} {/tb_noc/west_up[0]/flit}
add wave -noupdate -group {west_up[0]} {/tb_noc/west_up[0]/enable}
add wave -noupdate -group {west_up[0]} {/tb_noc/west_up[0]/ack}
add wave -noupdate -group {south_down[0]} {/tb_noc/south_down[0]/flit}
add wave -noupdate -group {south_down[0]} {/tb_noc/south_down[0]/enable}
add wave -noupdate -group {south_down[0]} {/tb_noc/south_down[0]/ack}
add wave -noupdate -group {south_up[0]} {/tb_noc/south_up[0]/flit}
add wave -noupdate -group {south_up[0]} {/tb_noc/south_up[0]/enable}
add wave -noupdate -group {south_up[0]} {/tb_noc/south_up[0]/ack}
add wave -noupdate -divider {Node(0,1) IF}
add wave -noupdate -group {north_down[1]} {/tb_noc/north_down[1]/flit}
add wave -noupdate -group {north_down[1]} {/tb_noc/north_down[1]/enable}
add wave -noupdate -group {north_down[1]} {/tb_noc/north_down[1]/ack}
...
add wave -noupdate -group {south_down[1]} {/tb_noc/south_down[1]/flit}
add wave -noupdate -group {south_down[1]} {/tb_noc/south_down[1]/enable}
add wave -noupdate -group {south_down[1]} {/tb_noc/south_down[1]/ack}
add wave -noupdate -group {south_up[1]} {/tb_noc/south_up[1]/flit}
add wave -noupdate -group {south_up[1]} {/tb_noc/south_up[1]/enable}
add wave -noupdate -group {south_up[1]} {/tb_noc/south_up[1]/ack}
add wave -noupdate -group {east_down[0]} {/tb_noc/east_down[0]/flit}
add wave -noupdate -group {east_down[0]} {/tb_noc/east_down[0]/enable}
add wave -noupdate -group {east_down[0]} {/tb_noc/east_down[0]/ack}
add wave -noupdate -group {east_up[0]} {/tb_noc/east_up[0]/flit}
add wave -noupdate -group {east_up[0]} {/tb_noc/east_up[0]/enable}
add wave -noupdate -group {east_up[0]} {/tb_noc/east_up[0]/ack}
add wave -noupdate -divider Node(0,0)
add wave -noupdate -group {node[0][0]} {/tb_noc/DUT/mesh/\nodes_h[0].nodes_w[0].node /clk}
...
add wave -noupdate -group {node[0][0]} -color Orange {/tb_noc/DUT/mesh/\nodes_h[0].nodes_w[0].node /cb/\dest[2] }
...
add wave -noupdate -group {node[0][1]} {/tb_noc/DUT/mesh/\nodes_h[0].nodes_w[1].node /cb/\dest[0] }
...
add wave -noupdate -group {node[0][1]} -color Orange {/tb_noc/DUT/mesh/\nodes_h[0].nodes_w[1].node /cb/\dest[3] }
...
add wave -noupdate {/tb_noc/DUT/mesh/* }
delete wave {/tb_noc/DUT/mesh/*node*}
delete wave {/tb_noc/DUT/mesh/*BUF*}
delete wave {/tb_noc/DUT/mesh/clk}
delete wave {/tb_noc/DUT/mesh/rst}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {10053930 ps} 0}
...
update
WaveRestoreZoom {9844694 ps} {10596806 ps}
